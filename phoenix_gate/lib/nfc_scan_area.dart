...
class _NfcScanAreaState extends State<NfcScanArea>
    ...
    return GestureDetector(
      ...
      child: DottedBorder(
        options: RoundedRectDottedBorderOptions(
          ...
          dashPattern: [6, 4],
          strokeWidth: 2.0,
          color: settings.fontColor.withValues(alpha: 0.6),
        ),
        child: Container(
            ...
            children: [
              ...
              Builder(
                builder: (_) {
                  ...
                  final showSecondary =
                      !widget.scanning && widget.ownershipResult == null;
                  return Column(
                    children: [
                      Text(
                        titleText,
  ...
  Widget _buildImagePlaceholder(SettingsModel settings) {
  ...
  Widget _buildContent(SettingsModel settings) {
    if (widget.scanning) {
